...
import {IExecutiveLeadershipsCard} from "@/types/components";
import {fadeIn, stagger, initial, initialTwo} from "@/animations/animations";

// Components
import Paragraph from "../Elements/Paragraph";

const ExecutiveLeadershipsCard: FC<IExecutiveLeadershipsCard> = ({
	slug,
	title,
	paragraph,
	featuredImage,
...
export default ExecutiveLeadershipsCard;
